...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        confirmCodeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent confirmCodeActivityIntent = new Intent(MainActivity.this, ConfirmPassCodeActivity.class);
                confirmCodeActivityIntent.putExtra("Actual Value", actualValue.toString());
                confirmCodeActivityIntent.putExtra("PassCode Value", pressureValue.toString());
                startActivity(confirmCodeActivityIntent);
            }
        });
    }
}
